...
from mslt_port.data import (get_delayed_prevalence,
                            get_delayed_incidence,
                            get_delayed_remission,
                            get_delayed_disease_rr,
                            get_delayed_mortality_rr)
...
class DelayedRisk:
    ...
    def setup(self, builder):
        ...
        prev_data = get_delayed_prevalence(self.name)
        ...
        inc_data = builder.lookup.build_table(get_delayed_incidence(self.name))
        ...
        rem_data = builder.lookup.build_table(get_delayed_remission(self.name))
        ...
        mort_rr_data = get_delayed_mortality_rr(self.name)
        ...
        dis_rr_data = get_delayed_disease_rr(self.name)
        self.dis_rr = {}
